...
#This section allows you to pick a specific requirement or piece of ontology you wish to have analyzed.  After the requirement document and ontology have been
#evaluated, information pertaining to the desired requirement and ontology number will be returned.  The ontology number is the index of the ontology from the
#.OWL file.  In the case of this ontology the ontology ID numbers are:
...
initial_semantic_threshold = 0.45 #WARNING: it is not recommended to set this lower than 0.40 unless you comment out the weighted_pathing_tool() function on line 106 below.
